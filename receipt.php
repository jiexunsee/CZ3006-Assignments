...
<body>
	<?php
		$name = $_POST["name"]; // extract the form fields from the POST data
		$apple = $_POST["apples"];
		...
		$prevOranges = 0;
		$prevBananas = 0;
		if ($fileContents !== FALSE){ // then the file already exists and we managed to read it
	...
	?>
		...
		<table border="border" width="300">
			...
			<tr>
				...
				<td align="center">
					<?php print ("$".number_format($apple * 0.69, 2)); ?> <!-- Setting the price to have two decimal places -->
				</td>
			</tr>
			<tr>
				<th>Oranges</th>
